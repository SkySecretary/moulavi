              ...
              <div className="p-6">
                {(() => {
                  switch (bookingState.currentStep) {
                    ...
                    case 2: return <TravelDetailsStep data={bookingState.step2Data} onChange={updateStep2Data} airports={masterData.airports} disabled={isLoading} allowOneWayOption={bookingState.step1Data.bookingMode === 'travel_details' && (globalAllowOneWayTicket || selectedParty?.allowOneWayTicket)} />;
