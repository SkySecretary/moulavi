...
export default function PartyMissingReturnTicketPage() {
  ...
  return (
    <PartyLayout title="Missing Return Tickets" subtitle="Please update the return ticket details for your onward-only bookings.">
      <div className="flex-1 flex flex-col h-full bg-gray-50/50 p-4 lg:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium">Please update the return ticket details for your onward-only bookings.</p>
          </div>
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className="text-center py-20">
                      <div className="flex flex-col items-center justify-center space-y-2">
                        ...
                        <p className="text-xs text-slate-400">All your bookings have return tickets assigned.</p>
                      </div>
                    </TableCell>
                  </TableRow>
                ) : (
                      ...
                      <TableRow key={booking.id} className="hover:bg-slate-50/50 border-b border-slate-100">
                        ...
                        <TableCell className="py-3.5">
                          {booking.oneWayContactName ? (
                            <div className="flex flex-col p-1.5 bg-indigo-50/50 border border-indigo-100/50 rounded-lg max-w-[180px]">
                              <span className="text-[10px] font-bold text-indigo-900 truncate">{booking.oneWayContactName}</span>
